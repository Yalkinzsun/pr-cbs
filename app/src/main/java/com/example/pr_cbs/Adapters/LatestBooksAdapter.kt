...
class LatestBooksAdapter(private val context: Context?) :
    RecyclerView.Adapter<LatestBooksAdapter.ViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return LatestBooksStorage.Instance().availableRecordsCount
    }


    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val latestBook = LatestBooksStorage.Instance().getRecordById(position)
